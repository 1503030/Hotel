...
<body>
<h3>Please enter salads menu</h3>
...
<div class="row mt-4">
  ...
  <a class="list-group-item list-group-item-action " data-toggle="list" href="nine.php" role="tab">Add Menu</a>
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body" style="background-color:#3498DB;color:#ffffff;">
					<form class="form-group" action="add9.php" method="post" enctype="multipart/form-data">
